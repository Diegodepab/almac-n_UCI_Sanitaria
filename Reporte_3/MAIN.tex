...
Antes de desplegar el cubo, tendremos hacer unos cambios en los grupos de medida para que las tablas NxM funcionen correctamente. 

El principal cambio es el que se ve en la Figura \ref{fig:30}. En la que tendremos que poner en Ingreso UCI y en las filas Allergy, Diagnosis y Medication sus correspondientes tablas intermedias para que se relacionen esas tablas con el hecho con relación varios a varios. 
...
Con el resto de tablas, Allergy, Diagnosis y Medication, no tienen relación por lo que se pueden quedar vacías. ç

Además también habrá que poner Allergy ID como atributo de granularidad entre las tablas Allergy y UCI\_Alergia (Tendremos que hacer lo mismo para el resto de tablas intermedias).

\subsubsection{Despliegue del cubo}

Una vez hayamos realizado todos estos pasos podremos desplegar el cubo. Bastará con darle al botón de iniciar. Y si lo hemos hecho bien saldrá un check en verde \ref{fig:31}
